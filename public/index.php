...
<style>
  ...
  .brand-shadow { box-shadow: 0 4px 24px 0 rgba(79,55,138,0.35); }
  @keyframes fade-up {
...
<div class="absolute inset-0 z-0 overflow-hidden pointer-events-none" aria-hidden="true">
  <div class="absolute top-[-20%] left-[-10%] w-[70vw] h-[70vw] rounded-full bg-primary-fixed opacity-40 blur-3xl"></div>
  <div class="absolute bottom-[-20%] right-[-10%] w-[60vw] h-[60vw] rounded-full bg-primary opacity-10 blur-3xl"></div>
</div>

<!-- Main Content -->
<main class="relative z-10 flex flex-col items-center justify-center px-6 py-12 max-w-2xl text-center animate-fade-up">
  ...
  <div class="w-28 h-28 mb-8 relative delay-1 animate-fade-up">
    ...
    <div class="absolute inset-0 bg-primary-light rounded-3xl rotate-45 flex items-center justify-center shadow-xl border border-white/20">
      <span class="material-symbols-outlined text-white -rotate-45" style="font-size:52px;font-variation-settings:'FILL' 1;">
        medical_services
      </span>
    </div>
  </div>
  ...
  <div class="flex flex-wrap items-center justify-center gap-3 mt-10 delay-3 animate-fade-up">
    ...
    <span class="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-primary-fixed text-primary text-xs font-bold border border-primary/20">
      <span class="material-symbols-outlined text-[14px]">stethoscope</span>Dokter
    </span>
    <span class="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-teal-50 text-teal-600 text-xs font-bold border border-teal-100">
