...
<div class="flex min-h-screen">
  ...
  <!-- Sidebar -->
  <aside class="w-64 bg-slate-900 flex-shrink-0 flex-col hidden md:flex">
    <div class="p-6 border-b border-slate-800">
      <div class="flex items-center gap-2">
        <div class="w-8 h-8 bg-teal-500/20 flex items-center justify-center rounded-lg transform rotate-45 border border-teal-500/30">
          <span class="material-symbols-outlined text-teal-400 transform -rotate-45 text-[16px]" style="font-variation-settings:'FILL' 1;">medical_services</span>
        </div>
        <span class="font-extrabold tracking-tight text-white text-sm">CareConnect <span class="text-teal-400 text-xs font-bold">Admin</span></span>
      </div>
    </div>
    ...
    <div class="p-4 border-b border-slate-800">
      <div class="flex items-center gap-3">
        <div class="w-10 h-10 bg-teal-500/20 text-teal-400 rounded-full flex items-center justify-center font-bold text-sm border border-teal-500/30">
